...
const Footer = () => {
    return (
      <div className="flex flex-col items-center justify-center h-[280px] gap-6 bg-[#f5f7fa] border-black pt-12 pb-12"> {/* Added padding-top */}
        <div className="flex items-center gap-8 md:gap-0 flex-col md:flex-row justify-center w-full">
            ...
            <div className="flex w-full md:w-2/5 gap-4 text-gray-600 items-center justify-center"> {/* Gap between columns */}
                <div className="flex-1 flex flex-col gap-4 items-left md:items-center justify-center"> {/* Changed gap */}
