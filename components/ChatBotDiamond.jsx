...
export default function ChatBotDiamond() {
    ...
    if (newMessage.trim() !== "") {
      ...
      const response = await fetch("https://chatbot-backend-yr1g.onrender.com/chat", {
        ...
        body: JSON.stringify({
          ...
          bot: "bot3",     // Specify which bot you want to use
        }),
      });
  ...
  return (
    <div className="items-center outfit mesh-diamond bg-white mt-10 min-h-screen flex flex-col justify-center">
      {/* Title Section */}
      <div className="flex flex-col justify-center items-center mb-5">
        <h5 className="text-xl md:text-3xl text-center tracking-tight text-[var(--g)] font-medium">
          Trippo Diamond
        </h5>
        <h3 className="text-2xl md:text-4xl text-center bg-gradient-to-r from-[#47c8e8] via-[#0398bd] to-[#47c8e8] bg-clip-text text-transparent mb-5 mx-5 font-semibold tracking-tighter">
          Super Advanced Travel Companion
        </h3>
      </div>
